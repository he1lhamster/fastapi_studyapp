...
class OperationsService:
    ...
    def create(self, user_id: int, operations_data: OperationCreate) -> tables.Operation:
    ...
    def update(self, user_id: int, operation_id: int, operation_data: OperationCreate) -> tables.Operation:
